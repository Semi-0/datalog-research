...
(def externalize-accessor-value network-slot/externalize-accessor-value)
(def externalize-accessor-network network-slot/externalize-accessor-network)
(def externalize-accessor-cell network-slot/externalize-accessor-cell)
